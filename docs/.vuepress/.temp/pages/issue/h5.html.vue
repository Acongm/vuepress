<template><h1 id="h5-相关" tabindex="-1"><a class="header-anchor" href="#h5-相关" aria-hidden="true">#</a> H5 相关</h1>
<h2 id="webview-返回上一页不刷新" tabindex="-1"><a class="header-anchor" href="#webview-返回上一页不刷新" aria-hidden="true">#</a> WebView 返回上一页不刷新</h2>
<h4 id="原因" tabindex="-1"><a class="header-anchor" href="#原因" aria-hidden="true">#</a> 原因</h4>
<p>为了提升浏览网页的效率加入了缓存机制</p>
<h4 id="解决方案" tabindex="-1"><a class="header-anchor" href="#解决方案" aria-hidden="true">#</a> 解决方案</h4>
<p>监听 <code>pageshow</code> 事件，通过 <code>persisted</code> 或者 <code>performance.navigation.type</code> 属性判断当前页面是否通过缓存载入</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">pageshowFn</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
