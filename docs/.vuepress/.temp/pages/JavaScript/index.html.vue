<template><h1 id="js-基础知识" tabindex="-1"><a class="header-anchor" href="#js-基础知识" aria-hidden="true">#</a> js 基础知识</h1>
<h2 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h2>
<blockquote>
<p>原始类型存储的都是值，没有函数可以调用</p>
</blockquote>
...
<h3 id="复杂类型" tabindex="-1"><a class="header-anchor" href="#复杂类型" aria-hidden="true">#</a> 复杂类型</h3>
<ul>
<li>7？、Object</li>
<li>8？、bigInt</li>
</ul>
<h2 id="对象类型和原始类型的不同之处-函数参数是对象会发生什么问题" tabindex="-1"><a class="header-anchor" href="#对象类型和原始类型的不同之处-函数参数是对象会发生什么问题" aria-hidden="true">#</a> 对象类型和原始类型的不同之处？函数参数是对象会发生什么问题？</h2>
<ul>
<li>当我们将变量赋值给另外一个变量时，复制的是原本变量的地址（指针），也就是说当前变量 b 存放的地址（指针）也是 #001，当我们进行数据修改的时候，就会修改存放在地址（指针） #001 上的值，也就导致了两个变量的值都发生了改变。</li>
</ul>
<ul>
<li>总结， 正常变量赋值中（在“=” 情况下），都是复制原本变量地址,</li>
</ul>
<h2 id="typeof-是否能正确判断类型-instanceof-能正确判断对象的原理是什么" tabindex="-1"><a class="header-anchor" href="#typeof-是否能正确判断类型-instanceof-能正确判断对象的原理是什么" aria-hidden="true">#</a> typeof 是否能正确判断类型？instanceof 能正确判断对象的原理是什么？</h2>
<ul>
<li>1、typeof 只能判读一些原始类型， 对于数组、对象、函数等，不能准确的判断</li>
<li>2、如果我们想判断一个对象的正确类型，这时候可以考虑使用 instanceof，因为内部机制是通过原型链来判断的。</li>
<li>3、Symbol.hasInstance 可自定义对象的 instanceof 值</li>
</ul>
<h2 id="类型转换" tabindex="-1"><a class="header-anchor" href="#类型转换" aria-hidden="true">#</a> 类型转换</h2>
<ul>
<li>1、转换为布尔值
<ul>
<li>在条件判断时，除了 undefined， null， false， NaN， ''， 0， -0，其他所有值都转为 true，包括所有对象。</li>
</ul>
</li>
<li>2、转换为数字</li>
<li>3、转换为字符串</li>
</ul>
<h3 id="对象转原始类型" tabindex="-1"><a class="header-anchor" href="#对象转原始类型" aria-hidden="true">#</a> 对象转原始类型</h3>
<p>对象在转换类型的时候，会调用内置的 [[ToPrimitive]] 函数，对于该函数来说，算法逻辑一般来说如下：</p>
<ul>
...
<h2 id="如何正确判断-this-箭头函数的-this-是什么" tabindex="-1"><a class="header-anchor" href="#如何正确判断-this-箭头函数的-this-是什么" aria-hidden="true">#</a> 如何正确判断 this？箭头函数的 this 是什么？</h2>
<h2 id="和-有什么区别" tabindex="-1"><a class="header-anchor" href="#和-有什么区别" aria-hidden="true">#</a> == 和 === 有什么区别？</h2>
<ul>
<li>对于 === 来说就简单多了，就是判断两者类型和值是否相同。</li>
<li>对于 == 来说，就要:判断类型-&gt;判断 null==undefined-&gt;string==number-&gt;boolean==number-&gt;object==(string||number||symbol)-&gt;结果</li>
</ul>
<h2 id="什么是闭包" tabindex="-1"><a class="header-anchor" href="#什么是闭包" aria-hidden="true">#</a> 什么是闭包？</h2>
<ul>
<li>闭包的定义其实很简单：函数 A 内部有一个函数 B，函数 B 可以访问到函数 A 中的变量，那么函数 B 就是闭包。</li>
<li>类似一个背包</li>
<li>闭包存在的意义就是让我们可以间接访问函数内部的变量。</li>
</ul>
<h2 id="什么是浅拷贝-如何实现浅拷贝-什么是深拷贝-如何实现深拷贝" tabindex="-1"><a class="header-anchor" href="#什么是浅拷贝-如何实现浅拷贝-什么是深拷贝-如何实现深拷贝" aria-hidden="true">#</a> 什么是浅拷贝？如何实现浅拷贝？什么是深拷贝？如何实现深拷贝？</h2>
<h3 id="什么是浅拷贝" tabindex="-1"><a class="header-anchor" href="#什么是浅拷贝" aria-hidden="true">#</a> 什么是浅拷贝</h3>
<ul>
<li>对象类型在赋值的过程中其实是复制了地址，从而会导致改变了一方其他也都被改变的情况。通常在开发中我们不希望出现这样的问题，我们可以使用浅拷贝来解决这个情况。</li>
<li>Object.assign 就是用来浅拷贝所有属性到新对象中。如果是属性值对象的话，拷贝的是自己</li>
<li>另外我们还可以通过展开运算符 ... 来实现浅拷贝</li>
<li>浅拷贝只解决了第一层的问题，如果接下去的值中还有对象的话，就需要深拷贝</li>
</ul>
<h3 id="什么是深拷贝" tabindex="-1"><a class="header-anchor" href="#什么是深拷贝" aria-hidden="true">#</a> 什么是深拷贝</h3>
<ul>
<li>JSON.parse(JSON.stringify(object)) 实现深拷贝
<ul>
<li>会忽略 undefined</li>
<li>会忽略 symbol</li>
<li>不能序列化函数</li>
...
<h3 id="如何理解原型-如何理解原型链" tabindex="-1"><a class="header-anchor" href="#如何理解原型-如何理解原型链" aria-hidden="true">#</a> 如何理解原型？如何理解原型链？</h3>
<ul>
<li>
<p>原型的 constructor 属性指向构造函数，构造函数又通过 prototype 属性指回原型，</p>
</li>
<li>
<p>但是并不是所有函数都具有这个属性，Function.prototype.bind() 就没有这个属性。</p>
</li>
<li>
<p>其实原型链就是多个对象通过 <strong>proto</strong> 的方式连接了起来。</p>
</li>
<li>
<p>为什么 obj 可以访问到 valueOf 函数，就是因为 obj 通过原型链找到了 valueOf 函数。</p>
</li>
<li>
<p>对于这一小节的知识点，总结起来就是以下几点：</p>
</li>
<li>
<p>Object 是所有对象的爸爸，所有对象都可以通过 <strong>proto</strong> 找到它</p>
</li>
<li>
<p>Function 是所有函数的爸爸，所有函数都可以通过 <strong>proto</strong> 找到它</p>
</li>
<li>
<p>函数的 prototype 是一个对象</p>
</li>
<li>
<p>对象的 <strong>proto</strong> 属性指向原型， <strong>proto</strong> 将对象和原型连接起来组成了原型链</p>
</li>
</ul>
<h2 id="es6-知识点及常考面试题" tabindex="-1"><a class="header-anchor" href="#es6-知识点及常考面试题" aria-hidden="true">#</a> ES6 知识点及常考面试题</h2>
<h3 id="原型如何实现继承-class-如何实现继承-class-本质是什么" tabindex="-1"><a class="header-anchor" href="#原型如何实现继承-class-如何实现继承-class-本质是什么" aria-hidden="true">#</a> 原型如何实现继承？Class 如何实现继承？Class 本质是什么？</h3>
<h4 id="组合继承" tabindex="-1"><a class="header-anchor" href="#组合继承" aria-hidden="true">#</a> 组合继承</h4>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Parent</span><span class="token punctuation">(</span><span class="token parameter">value</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
child<span class="token punctuation">.</span><span class="token function">getValue</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">// 1</span>
child <span class="token keyword">instanceof</span> <span class="token class-name">Parent</span> <span class="token comment">// true</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><h4 id="class-继承" tabindex="-1"><a class="header-anchor" href="#class-继承" aria-hidden="true">#</a> Class 继承</h4>
...
child<span class="token punctuation">.</span><span class="token function">getValue</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">// 1</span>
child <span class="token keyword">instanceof</span> <span class="token class-name">Parent</span> <span class="token comment">// true</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h3 id="为什么要使用模块化" tabindex="-1"><a class="header-anchor" href="#为什么要使用模块化" aria-hidden="true">#</a> 为什么要使用模块化？</h3>
<ul>
<li>解决命名冲突</li>
<li>提供复用性</li>
<li>提高代码可维护性</li>
</ul>
<h3 id="都有哪几种方式可以实现模块化-各有什么特点" tabindex="-1"><a class="header-anchor" href="#都有哪几种方式可以实现模块化-各有什么特点" aria-hidden="true">#</a> 都有哪几种方式可以实现模块化，各有什么特点？</h3>
<ul>
<li>立即执行函数</li>
<li>AMD 和 CMD</li>
<li>CommonJS</li>
...
<h3 id="proxy-可以实现什么功能" tabindex="-1"><a class="header-anchor" href="#proxy-可以实现什么功能" aria-hidden="true">#</a> Proxy 可以实现什么功能？</h3>
<blockquote>
